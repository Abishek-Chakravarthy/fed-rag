...
RETRIEVER_MODEL = "sentence-transformers/multi-qa-MiniLM-L6-cos-v1" # Strong retriever used for robustness-style runs.
MECHANISM_RETRIEVER_MODEL = "sentence-transformers/multi-qa-MiniLM-L6-cos-v1" # Step 1 diagnostic proved paraphrase-MiniLM-L3-v2 degrades under LSR (-7.1%); all-MiniLM-L6-v2 improved +10.3%.
